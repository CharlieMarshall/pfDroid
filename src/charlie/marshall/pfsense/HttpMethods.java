...
public class HttpMethods
{
	...
	URL loginurl;
	Scanner inStream;
	HttpCookieStore cookieStore = null;
	...
	public HttpMethods(HttpCookieStore cookieStore) throws MalformedURLException
	{
	...
	public Scanner getPage() throws IOException, ParserConfigurationException, SAXException
	{
		...
		while (responseCode != 200 )
		{
			...
			case 302:
				...
				loginurl = new URL (httpconn.getHeaderField("Location"));
			case 0:
				// For when I have reset it to 0

				httpconn=(HttpURLConnection)loginurl.openConnection();
				cookieStore.setCookiesHTTP(httpconn);
				httpconn.setRequestMethod("GET");
				inStream = new Scanner(httpconn.getInputStream(), "ISO-8859-1");
				responseCode = httpconn.getResponseCode();
				cookieStore.storeCookiesHTTP(httpconn);
	...
	{
		Document doc = Jsoup.parse(httpconn.getInputStream(), "ISO-8859-1", loginurl.toString() );
